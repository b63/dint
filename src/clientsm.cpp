...
std::shared_ptr<std::vector<char>> ClientSM::get_payload()
{
...
int ClientSM::process_record(const std::vector<char> &record,
...
void ClientSM::process_server_verification(const std::vector<char> &record,
...
void ClientSM::process_server_yo_record(const std::vector<char> &record,
        const header_t &header)
{
...
void ClientSM::process_dhe_params(const std::vector<char> &record, size_t offset)
{
    try {
