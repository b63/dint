...
namespace dint {
    ...
    {
    public:
        ServerSM(bool require_certificate = false);
        void close();
        void reset();
        void start_protocol();
    ...
    private:
        ...
        void process_client_yo_record(const std::vector<char> &record, const header_t &header);
        void process_client_verification(const std::vector<char> &record, const header_t &header);
